...
class MenuTabViewController: UIViewController {
    ...
    func configureTableView() {
        ...
        let third = ItemTabData(id: 2, image: "ic_third_party_payment", title: "Pago de cuotas de terceros", subtitle: "Abonos a compras activas de crédito de otras personas")
        let status = ItemTabData(id: 3, image: "ic_payment_status", title: "Estados de cuentas", subtitle: "Estado de cuentas a la fecha")
