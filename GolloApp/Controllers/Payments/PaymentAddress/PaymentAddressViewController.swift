...
class PaymentAddressViewController: UIViewController {
    ...
    init(viewModel: PaymentAddressViewModel, creditSelected: Bool) {
        self.viewModel = viewModel
        self.viewModel.processDocTypes()
        self.isCreditSelected = creditSelected
    ...
    fileprivate func setUserData() {
        ...
        self.viewModel.preApprovedSubject.accept(isCreditSelected)
    }
...
extension PaymentAddressViewController: UITextFieldDelegate {
